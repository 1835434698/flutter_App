...
class MainBloc implements BlocBase {
  ...
  Future getLoginData(String username, String password) {
    LoginReq _loginReq = new LoginReq(username,password);
    return getLogin(_loginReq);
  }
...
//      _homeEventSink.add(new StatusEvent(labelId, RefreshStatus.failed));
      _homeEventSink.add(new StatusEvent(labelId, -1));
    });
  }
