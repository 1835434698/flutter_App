...
class SplashPageState extends State<SplashPage> {
  ...
  List<String> _guideList = [
    Utils.getImgPath('guidepage_1'),
    Utils.getImgPath('guidepage_2')
  ];
...
//        SpUtil.putBool(Constant.key_guide, false);
  ...
  void _loadSplashData() {
    ...
    httpUtil.getSplash().then((model) {
      LogUtil.e("_loadSplashData......model.imgUrl = "+model.imgUrl, tag: tag);
      if (!ObjectUtil.isEmpty(model.imgUrl)) {
        LogUtil.e("_loadSplashData......_splashModel.imgUrl = "+_splashModel.imgUrl, tag: tag);
...
//
  ...
  void _doCountDown() {
    ...
    _timerUtil.setOnTimerTickCallback((int tick) {
      ...
      LogUtil.e("_doCountDown......_tick = "+_tick.toString(), tag: tag);
      if (_tick == 0) {
        _goMain();
      }
    });
  ...
  Widget build(BuildContext context) {
    LogUtil.e("build......_status = "+_status.toString(), tag: tag);
    return new Material(
      child: new Stack(
        children: <Widget>[
          new Offstage(
